          ...
          {allAppointments.map((appointment) => {
            ...
            return (
              <button
                ...
                className={`flex-grow flex w-full md:flex-col gap-0.5 text-sm h-20 justify-center items-center rounded-sm font-bold ${isActive ? '' : 'pointer-events-none opacity-50 bg-zinc-700'} ${getBgColor(
