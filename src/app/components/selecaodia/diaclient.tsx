...
export function DiaClient({
  ...
  selectedHorarios: propSelectedHorarios,
}: {
  ...
  const handleSelectHorario = (horario: AgendaNew) => {
    ...
    if (newSelectedHorarios.some((h) => h.horario === horario.horario)) {
            ...
            <div
              ...
              className={`flex-grow flex w-full md:flex-col gap-1 h-20 justify-center items-center rounded-sm font-bold ${
                ...
                !isInactive(appointment)
                  ...
                  : 'cursor-not-allowed'
              } ${getBgColor(appointment.Cliente.nome, isInactive(appointment))}`}
